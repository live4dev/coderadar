  ...
  const rows = projects.map(p => `
    <tr>
      ...
      <td onclick="event.stopPropagation()" style="white-space:nowrap">
        ...
        <button class="btn btn-danger" style="padding:3px 10px;font-size:12px;margin-left:6px" onclick="adminProjDelete(${p.id}, ${esc(JSON.stringify(p.name))})">Delete</button>
      </td>
    </tr>`).join('');
